...
* `Governance.sol <https://github.com/HyperLink-Technology/SFT-Protocol/tree/master/contracts/modules/Governance.sol>`__: A minimal implementation of ``Goverance``, intended for testing purposes or as a base for building a functional contract.
* `IGovernance.sol <https://github.com/HyperLink-Technology/SFT-Protocol/tree/master/contracts/interfaces/IGovernance.sol>`__: The minimum contract interface required for a governance module to interact with an ``IssuingEntity`` contract.
