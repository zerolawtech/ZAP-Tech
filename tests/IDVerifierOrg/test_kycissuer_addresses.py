...
def test_add_addresses_known_address(ikyc):
    ...
    ikyc.addMember("0x123456", 1, 1, 1, 9999999999, accounts[5:7], {'from': accounts[0]})
...
def test_restrict_wrong_ID(ikyc):
    ...
    ikyc.addMember("0x123456", 1, 1, 1, 9999999999, (accounts[6],), {'from': accounts[0]})
...
def test_owner_add_member_addresses(ikyc):
    ...
    ikyc.addMember("0x123456", 1, 1, 1, 9999999999, (accounts[5],), {'from': accounts[0]})
