...
def test_all_no_unvested(share, options, id1, issueoptions, sleep):
    ...
    assert share.balanceOf(accounts[1]) == 500


def test_all_some_unvested(share, options, id1, issueoptions, sleep):
    ...
    assert share.balanceOf(accounts[1]) == 300


def test_partial_no_unvested(share, options, id1, issueoptions, sleep):
    ...
    assert share.balanceOf(accounts[1]) == 350


def test_partial_some_unvested(share, options, id1, issueoptions, sleep):
...
def test_all_multiple(share, options, id1, issueoptions, sleep):
...
def test_all_multiple_some_unvested(share, options, id1, issueoptions, sleep):
...
def test_one_multiple(share, options, id1, issueoptions, sleep):
...
def test_partial_multiple(share, options, id1, issueoptions, sleep):
    '''exercise all across multiple Options'''
    issueoptions(id1, 10)
    sleep(1)
    issueoptions(id1, 10)
    ...
    assert share.balanceOf(accounts[1]) == 400
    options.exerciseOptions(10, 400, {'from': accounts[1], 'amount': 4000})
    assert options.getOptions(id1) == (200, 0, [(10, 1)])
    assert share.balanceOf(accounts[1]) == 800


def test_partial_multiple_some_unvested(share, options, id1, issueoptions, sleep):
