...
def cust_out():
    ...
    check.equal(token.custodianRangesOf(a[1], cust), ((1, 10001),))
    ...
    check.equal(token.custodianRangesOf(a[2], cust), ((1, 10001),))
    ...
    check.equal(token.custodianRangesOf(a[2], cust), ())
    check.equal(token.rangesOf(a[2]), ((1, 10001),))
    check.equal(issuer.getInvestorCounts()[0][0:3], (1, 0, 1))
